...
const usersL = {
  ...
  ar:{title:'إدارة المستخدمين',sub:'المستخدمون المسجلون في المنصة',btn_import:'استيراد CSV',btn_export:'تصدير',btn_add:'مستخدم جديد',kpi_total:'إجمالي المستخدمين',kpi_active:'نشطون',kpi_inactive:'غير نشطين',kpi_risk:'مخاطر عالية',kpi_avg_comp:'متوسط الإتمام',search_ph:'ابحث عن مستخدمين...',all_depts:'جميع الأقسام',all_status:'جميع الحالات',all_risk:'جميع المخاطر',status_active:'نشط',status_inactive:'غير نشط',risk_low:'منخفض',risk_med:'متوسط',risk_high:'عالٍ',table_title:'قائمة المستخدمين',btn_notify:'إشعار',btn_bulk_assign:'تعيين جماعي',col_user:'المستخدم',col_dept:'القسم',col_role:'الدور',col_completion:'الإتمام',col_certs:'الشهادات',col_risk:'مستوى المخاطر',col_last_login:'آخر تسجيل دخول',col_actions:'الإجراءات',showing:'عرض',of:'من',modal_title:'مستخدم جديد',field_name:'الاسم الكامل',field_email:'البريد المؤسسي',field_dept:'القسم',field_role:'دور الوصول',field_lang:'اللغة المفضلة',field_country:'الدولة',send_invite:'إرسال دعوة عبر البريد',btn_cancel:'إلغاء',btn_create:'إنشاء المستخدم'},
};
...
const deptPageL = {
  ...
  ar:{ title:'الأقسام والمسارات', sub:'الهيكل التنظيمي ومسارات التعلم', btn_add:'قسم جديد', users_label:'مستخدمون', risk_low:'منخفض', risk_med:'متوسط', risk_high:'عالٍ', col_completion:'الإتمام', col_avg:'متوسط الدرجة', col_certs:'الشهادات', mandatory_label:'إلزامية:', trails_title:'مسارات التعلم', btn_new_trail:'مسار جديد', trail_cyber:'أساسيات الأمن السيبراني', trail_compliance:'الامتثال والأخلاق', trail_privacy:'الخصوصية و LGPD/GDPR', trail_leader:'القيادة الأخلاقية', modal_title:'قسم جديد', field_name:'الاسم', field_manager:'المدير المسؤول', field_country:'الدولة/المنطقة', btn_cancel:'إلغاء', btn_create:'إنشاء' },
};
